...
{
	public partial class putonggaimi : Form
	{
		public putonggaimi()
		{
			InitializeComponent();
		...
		public void button1_Click(object sender, EventArgs e)
		{
			...
			string sql = "select pwd from putongtable where pno ='" + textBox5.Text + "'";
			...
			if (sdr.Read())
			{
				...
				if (oldPwd == textBox2.Text)
				{
					...
					{
						sdr.Close();
						string sqlUpdate = "update putongtable set pwd ='" + textBox4.Text +
						"' where pno ='" + textBox5.Text + "'";
